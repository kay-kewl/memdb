...
DataType LiteralExpression::get_type() const {
...
DataType VariableExpression::get_type() const {
    return Type::Unknown;
}
...
DataType UnaryExpression::get_type() const {
    switch (op_) {
        case Operator::Not:
            return Type::Bool;
        case Operator::Length:
...
std::string UnaryExpression::to_string() const {
    switch (op_) {
        ...
        case Operator::Length:
            return "|" + operand_->to_string() + "|";
        default:
            return "unknown_unary_op(" + operand_->to_string() + ")";
    }
}
...
DataType BinaryExpression::get_type() const {
    switch (op_) {
        case Operator::Add:
        case Operator::Subtract:
        case Operator::Multiply:
...
std::string BinaryExpression::to_string() const {
    ...
    switch (op_) {
        ...
        case Operator::Modulo: op_str = "%"; break;
        ...
        case Operator::Xor: op_str = "^^"; break;
